...
**Naming exploration (closed):** The board letter thread [PHA-91](/PHA/issues/PHA-91) closed **without** a recorded **A / B / C** outcome — treat naming as paused until leadership records a new decision. **Historical A/B/C definitions** (vote frame): [PHA-36](/PHA/issues/PHA-36#comment-81a0f3fb-dfda-4762-9f52-89055613f844). **Reference copy** (hero + cheat sheet, for archive readers only): [docs/gtm/readme-hero-variants-pha36.md](docs/gtm/readme-hero-variants-pha36.md), [docs/gtm/board-vote-cheat-sheet-pha36.md](docs/gtm/board-vote-cheat-sheet-pha36.md). **Canonical surfaces:** this repo and **GitHub Releases** — product positioning notes live under [docs/gtm/](docs/gtm/).
...
| Brand / naming (archived thread + analysis) | [PHA-91](/PHA/issues/PHA-91) (closed) · [docs/gtm/brand-naming-candidates-v1.md](docs/gtm/brand-naming-candidates-v1.md) · historical frame [PHA-36](/PHA/issues/PHA-36) |
...
- **Brand naming (Pharos vs alternatives):** [docs/gtm/brand-naming-candidates-v1.md](docs/gtm/brand-naming-candidates-v1.md) — [PHA-91](/PHA/issues/PHA-91) closed without a recorded A/B/C; historical vote-option definitions [PHA-36](/PHA/issues/PHA-36).
