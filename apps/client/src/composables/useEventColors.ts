// Shared agent color palette — same 10 colors across all components
const AGENT_HEX_PALETTE = [
  '#3b82f6', '#22c55e', '#a855f7', '#ec4899',
  '#14b8a6', '#f97316', '#6366f1', '#84cc16',
  '#06b6d4', '#ef4444'
];

// Hash-based: same key always gets the same color, regardless of call order
...
export function getAgentColor(agentKey: string): string {
  return AGENT_HEX_PALETTE[_hashKey(agentKey) % AGENT_HEX_PALETTE.length];
}
